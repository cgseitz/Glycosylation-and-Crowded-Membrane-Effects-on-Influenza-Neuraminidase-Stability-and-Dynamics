...
echo "3 0" | gmx_mpi cluster -f glycosylated_rep1.trr -s subset.pdb -g clustering.log -dist clusteringdistance.xvg -sz clusteringsize.xvg -cl finalclusters.pdb -cutoff 0.08 -method gromos
